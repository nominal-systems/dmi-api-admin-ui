...
window.data = {
  ...
  pages: [
    {
      slug: 'dashboard',
      url: `${config.get('UI_BASE_URL')}/`,
      name: 'Dashboard',
      icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6',
    },
    {
      slug: 'integrations',
      url: `${config.get('UI_BASE_URL')}/integrations`,
      name: 'Integrations',
      icon: 'M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5'
    },
    {
      slug: 'events',
      url: `${config.get('UI_BASE_URL')}/events`,
      name: 'Events',
  ...
  async initMenu() {
    ...
    providersPage.subPages = providers.map(provider => {
      return {
        id: provider.id,
        name: provider.id,
        url: `${config.get('UI_BASE_URL')}/providers#/${provider.id}`,
